 ...
 * @e_ident: A pointer to an array with the ELF magic numbers.
 *
 * Description: Magic numerals split by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * print_type - Commits the comments of the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array with the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * print_entry - Commits the content of the entry point of an ELF header.
 ...
 * ELF title at the start of an ELF file.
